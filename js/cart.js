...
const Cart = (function () {
  ...
  // ---- Настройки доставки ----
  const ORDER_MIN          = 800;   // минимальная сумма заказа, ₽
  ...
  function buildCheckoutHtml() {
    ...
    return `
      ...
      <div class="cart-footer">
        <button class="btn-primary" id="submit-order-btn" disabled style="opacity:.45;cursor:not-allowed">Оплата временно недоступна</button>
      </div>`;
  }
